...
- (void)testMaxBreadcrumbs {
    ...
    XCTAssertEqual(self.crumbs.context->firstFileNumber, 0);
    XCTAssertEqual(self.crumbs.context->nextFileNumber, 0);
    [self.crumbs addBreadcrumb:@"Crumb 1"];
    XCTAssertEqual(self.crumbs.context->firstFileNumber, 0);
    XCTAssertEqual(self.crumbs.context->nextFileNumber, 1);
    [self.crumbs addBreadcrumb:@"Crumb 2"];
    XCTAssertEqual(self.crumbs.context->firstFileNumber, 0);
    XCTAssertEqual(self.crumbs.context->nextFileNumber, 2);
    [self.crumbs addBreadcrumb:@"Crumb 3"];
    XCTAssertEqual(self.crumbs.context->firstFileNumber, 0);
    XCTAssertEqual(self.crumbs.context->nextFileNumber, 3);
    [self.crumbs addBreadcrumb:@"Clear notifications"];
    XCTAssertEqual(self.crumbs.context->firstFileNumber, 1);
    XCTAssertEqual(self.crumbs.context->nextFileNumber, 4);
