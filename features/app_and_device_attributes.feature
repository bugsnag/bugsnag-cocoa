Feature: App and Device attributes present
  ...
  Scenario: App and Device info is as expected
    ...
    And the error payload field "events.0.device.osName" equals "iOS"
    ...
    #And the error payload field "events.0.device.orientation" equals "portrait"
    ...
    And the error payload field "events.0.app.id" equals "com.bugsnag.iOSTestApp"
    And the error payload field "events.0.app.releaseStage" equals "development"
    And the error payload field "events.0.app.type" equals "iOS"
