Then("The exception reflects malloc corruption occurred") do
  ...
  when "_nc_table_find_64"
    ...
    assert_equal(stacktrace[2]["method"], "notify_check")
    assert_equal(stacktrace[3]["method"], "notify_check_tz")
    assert_equal(stacktrace[4]["method"], "tzsetwall_basic")
    assert_equal(stacktrace[5]["method"], "localtime_r")
    assert_equal(stacktrace[6]["method"], "_populateBanner")
    assert_equal(stacktrace[7]["method"], "_CFLogvEx2Predicate")
    assert_equal(stacktrace[8]["method"], "_CFLogvEx3")
    assert_equal(stacktrace[9]["method"], "_NSLogv")
