...
static BSGKey const BSGKeyAppHangThresholdMillis    = @"appHangThresholdMillis";
...
static BSGKey const BSGKeyDiscardClasses            = @"discardClasses";
...
static BSGKey const BSGKeyLaunchDurationMillis      = @"launchDurationMillis";
...
static BSGKey const BSGKeyMaxStringValueLength      = @"maxStringValueLength";
...
static BSGKey const BSGKeyReportBackgroundAppHangs  = @"reportBackgroundAppHangs";
static BSGKey const BSGKeySendLaunchCrashesSynchronously = @"sendLaunchCrashesSynchronously";
